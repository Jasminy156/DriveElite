...
CREATE TABLE `carros` (
  ...
  `modelo` varchar(80) COLLATE utf8mb4_general_ci NOT NULL,
  `ano` int NOT NULL,
  `preco` decimal(12,2) NOT NULL,
  `quilometragem` int DEFAULT NULL,
  `motor` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cambio` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
-- Dump completed on 2026-02-23 17:17:37
